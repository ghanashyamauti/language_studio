...
import { ClipboardList, Clock, CheckCircle, XCircle, Search, Calendar, ChevronRight } from 'lucide-react';
...
export default function HodLeaveApprovals() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-jspm-navy">Leave Approvals</h1>
        <p className="text-gray-500 text-sm">Review and manage teacher leave applications</p>
      </div>
                  ...
                  <tr key={l.leave_id} className="hover:bg-slate-50/50 transition-colors">
                    ...
                    {activeTab === 'history' && (
                      <td className="py-3.5 px-4 text-slate-600">
                        {l.reviewed_by_name ? (
                          <div>
                            <div className="font-medium">{l.reviewed_by_name}</div>
                            {l.review_comment && (
