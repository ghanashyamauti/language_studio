  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-jspm-navy">My Leave Applications</h1>
          <p className="text-gray-500 text-sm">Apply for leave and track your status (Approved by Admin)</p>
        </div>
        <button
                ...
                {leaves.map((l) => (
                  <tr key={l.leave_id} className="hover:bg-slate-50/55 transition-colors">
                    ...
                    <td className="py-3.5 px-4 text-slate-500 max-w-xs">
                      {l.reviewed_by_name ? (
                        <div>
                          <div className="text-xs font-semibold text-slate-700">Reviewed by {l.reviewed_by_name} (Admin)</div>
