  ...
  const Field = ({ name, label, showKey }) => (
    <div>
      ...
      <div className="relative">
        <input type={show[showKey] ? 'text' : 'password'} className="input pr-10" value={form[name]}
  ...
  return (
    <div className="max-w-md space-y-6">
      <div>
        ...
        <p className="text-gray-500 text-sm">Default password is Test@123 — change it for security</p>
      </div>
      <div className="card">
